    ...
    <header class="header">
        <div class="content header__wrap">
            <div class="header__top">
                <a class="logo" href="https://github.com/morozov312/Simple-Grid-and-Pug" target="_blank"><img class="logo__img" src="<?php echo get_template_directory_uri() . '/assets/images/header/logo.png' ?>" alt="logo"></a>
